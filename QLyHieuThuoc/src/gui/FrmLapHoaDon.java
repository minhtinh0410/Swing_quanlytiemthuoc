...
public class FrmLapHoaDon extends JFrame implements ActionListener,MouseListener,TableModelListener,KeyListener{
	...
	public FrmLapHoaDon() {
		...
		btnXoa.setBackground(SystemColor.controlHighlight);
		...
		btnThemThuocTim.setBackground(SystemColor.controlHighlight);
		...
		btnThemHoaDon.setBackground(SystemColor.controlHighlight);
		...
		btnInHd.setBackground(SystemColor.controlHighlight);
		...
		btnThemDiaChi.setBackground(SystemColor.controlHighlight);
